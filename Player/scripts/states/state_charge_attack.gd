...
@onready var spin_effects_sprite_2d: Sprite2D = $"../../Sprite2D/SpinEffectsSprite2D"
@onready var spin_animation_player: AnimationPlayer = $"../../Sprite2D/SpinEffectsSprite2D/AnimationPlayer"
...
func charge_attack() -> void:
	...
	play_audio( sfx_spin )
	spin_effects_sprite_2d.visible = true
